...
const funnyStoryEvents: GameEvent[] = [
  ...
  { id: 's10', title: '合租室友太奇葩', description: '你搬进合租房，发现室友是个二次元宅男。他每天半夜对着手办说话，还把你的外卖吃了说是"供品"。更可怕的是，他说他喜欢你...', icon: '🏢', type: 'risk', guaranteed: false, options: [{ text: '搬家', percentMin: -12, percentMax: -6, probability: 0.6, description: '你连夜搬家，押金和违约金都打了水漂', moralValue: 5 }, { text: '感化他', percentMin: -3, percentMax: 8, probability: 0.4, description: '你请他吃了顿饭，他成了你的好朋友，还介绍了工作', moralValue: 15 }] },
...
const dailyConsumptionEvents: GameEvent[] = [
  ...
  { id: 'c3', title: '超市购物', description: '本来只想买点东西，结果逛了一小时。结账时发现：购物车里多了很多你不需要的东西，还有一只不知从哪钻进来的仓鼠', icon: '🛒', type: 'consumption', guaranteed: false, options: [{ text: '买下来', percentMin: -12, percentMax: -6, probability: 0.6, description: '你买下了所有东西，包括那只仓鼠', moralValue: -10 }, { text: '放回去', percentMin: -6, percentMax: -3, probability: 0.4, description: '你放回去，结果仓鼠咬了你一口', moralValue: -5 }] },
  { id: 'c4', title: '充话费', description: '手机收到短信说余额不足。你去充值，结果充错了号码！更惨的是，那个号码的主人居然是你暗恋的人！他/她给你发微信说：谢谢啊，傻子~', icon: '📱', type: 'consumption', guaranteed: true, options: [{ text: '再充一次', percentMin: -12, percentMax: -6, probability: 1, description: '你含泪又充了一次', moralValue: 0 }] },
  ...
  { id: 'c8', title: '打车回家', description: '下班太累了，不想挤地铁。你打了车，结果堵了很久才到家，车费比坐地铁贵很多', icon: '🚗', type: 'consumption', guaranteed: false, options: [{ text: '认了', percentMin: -12, percentMax: -5, probability: 0.8, description: '你看着计价器，心在滴血', moralValue: -5 }, { text: '投诉堵车', percentMin: -6, percentMax: 0, probability: 0.2, description: '司机说你行你上，你被赶下了车', moralValue: -10 }] },
...
const beingScammedEvents: GameEvent[] = [
  ...
  { id: 'sc5', title: '健身房促销', description: '健身房销售说今天办卡最便宜，还送私教课。你热血上头办了年卡，结果第二天去发现：器械全是坏的，私教离职了', icon: '💪', type: 'risk', guaranteed: false, options: [{ text: '维权', percentMin: -12, percentMax: -6, probability: 0.4, description: '你维权成功，退了部分钱', moralValue: 15 }, { text: '在家练', percentMin: -18, percentMax: -10, probability: 0.6, description: '你买了家用器械，比健身房还贵', moralValue: -10 }] },
  { id: 'sc6', title: '办卡充值', description: '理发店说充卡送钱。你充了钱，结果第二天理发店就关门了！门口贴着"装修中"，你等了三个月，店变成了奶茶店', icon: '💈', type: 'risk', guaranteed: false, options: [{ text: '认栽', percentMin: -18, percentMax: -10, probability: 0.6, description: '你发誓再也不办卡了', moralValue: -5 }, { text: '找新店', percentMin: -15, percentMax: -6, probability: 0.4, description: '新店说可以继承老店会员，但要用原价更多的钱升级', moralValue: -10 }] },
  { id: 'sc7', title: '扫码送礼物', description: '有人说扫码注册送小礼物。你扫了，结果注册了一堆APP，还被疯狂电话催债！', icon: '🎁', type: 'risk', guaranteed: false, options: [{ text: '注销', percentMin: -10, percentMax: -5, probability: 0.6, description: '你花了一段时间才把所有账户注销', moralValue: -5 }, { text: '举报', percentMin: 0, percentMax: 5, probability: 0.4, description: '举报后获得了一笔举报奖励', moralValue: 15 }] },
  { id: 'sc8', title: '抽奖骗局', description: '超市门口说购物满额可以抽奖。你抽中了一等奖：玉石打折！你以为捡了便宜，结果鉴定说你买的玉不值钱', icon: '🎰', type: 'risk', guaranteed: false, options: [{ text: '买了', percentMin: -15, percentMax: -8, probability: 0.5, description: '你买了个"传家宝"，回家发现裂了', moralValue: -15 }, { text: '跑了', percentMin: 0, percentMax: 0, probability: 0.5, description: '你跑了，店员在后面喊：大哥别走啊！', moralValue: 5 }] },
];

// ==================== 特殊收入事件库 (10%) ====================

const specialIncomeEvents: GameEvent[] = [
  { id: 'sp1', title: '彩票中奖', description: '你随手买的彩票居然中奖了！你激动地告诉了所有人，结果第二天发现：彩票洗衣服时被搅碎了', icon: '🎰', type: 'opportunity', guaranteed: false, options: [{ text: '欲哭无泪', percentMin: 0, percentMax: 0, probability: 0.7, description: '你发誓再也不买彩票了', moralValue: 0 }, { text: '拼接起来', percentMin: 20, percentMax: 40, probability: 0.3, description: '你花了很多时间拼接，居然还能兑奖！', moralValue: 15 }] },
  ...
  { id: 'sp3', title: '网红突然爆火', description: '你随手拍的视频突然上了热搜。标题是：某男子在街头做出这种事！评论区全是骂你的', icon: '📹', type: 'opportunity', guaranteed: false, options: [{ text: '解释', percentMin: -10, percentMax: 5, probability: 0.5, description: '你发了解释视频，又上了热搜：男子解释后网友不买账', moralValue: 10 }, { text: '蹭热度', percentMin: 20, percentMax: 50, probability: 0.5, description: '你趁热度直播带货，虽然被骂但赚了不少', moralValue: -15 }] },
  { id: 'sp4', title: '公司上市期权', description: '你入职时拿的期权终于兑现了！结果公司上市破发了，股价跌了很多！但老板说：别担心，我们对员工很好——给你们发了纪念品！', icon: '🏢', type: 'investment', guaranteed: false, options: [{ text: '卖股票', percentMin: -5, percentMax: 5, probability: 0.6, description: '你卖光了股票，发现纪念品都比股票值钱', moralValue: -5 }, { text: '继续持有', percentMin: 0, percentMax: 15, probability: 0.4, description: '你赌对了，股价后来涨了，你成了有钱人', moralValue: 10 }] },
  { id: 'sp5', title: '投稿被采用', description: '你学生时代写的小说突然被影视公司看中了！他们说要改编，但预算有限，只能给你一顿饭', icon: '✍️', type: 'opportunity', guaranteed: false, options: [{ text: '同意', percentMin: 8, percentMax: 20, probability: 0.6, description: '你吃了饭，虽然署名权没了，但获得了"选角建议权"', moralValue: 5 }, { text: '拒绝', percentMin: 30, percentMax: 60, probability: 0.4, description: '你拒绝了，结果另一个公司以更高的价格买走了版权', moralValue: 15 }] },
];

// ==================== 特殊支出事件库 (10%) ====================

const specialExpenseEvents: GameEvent[] = [
  { id: 'se1', title: '创业失败', description: '你决定自己当老板，开了个奶茶店。开业第一天：你妈带着七大姑八大姨来捧场，每人买了一杯，然后给你提了一堆"改进建议"...', icon: '📋', type: 'risk', guaranteed: false, options: [{ text: '听完建议', percentMin: -18, percentMax: -10, probability: 0.7, description: '你按建议改了配方，结果所有人都说不如以前好喝了', moralValue: 5 }, { text: '不听', percentMin: -12, percentMax: -5, probability: 0.3, description: '你坚持自己，亲戚们说你翅膀硬了，不再来了', moralValue: -5 }] },
  { id: 'se2', title: '投资P2P暴雷', description: '朋友推荐了一个超高收益的P2P，年化收益50%！你投了钱，第二天平台就跑路了。报警后警察说：这种案子很多，追回来的概率很低', icon: '💸', type: 'risk', guaranteed: false, options: [{ text: '报警', percentMin: -12, percentMax: -5, probability: 0.5, description: '你成了证人，但需要配合调查好久', moralValue: 10 }, { text: '找朋友算账', percentMin: -10, percentMax: -3, probability: 0.5, description: '朋友说他也亏了，还给你看了他的亏损截图，比你还多', moralValue: -10 }] },
  { id: 'se3', title: '借钱给朋友', description: '多年好友开口借钱，说下个月还。你借了一笔钱，结果下个月他说：再缓缓。又过了很久，他突然发微信：我听说你到处说我欠钱不还？', icon: '🤝', type: 'risk', guaranteed: false, options: [{ text: '解释', percentMin: -10, percentMax: -3, probability: 0.5, description: '你们大吵一架，钱还是要不回来', moralValue: 5 }, { text: '算了', percentMin: -15, percentMax: -6, probability: 0.5, description: '你决定不要了，但朋友也没了', moralValue: -10 }] },
  { id: 'se4', title: '酒驾被抓', description: '喝完酒觉得自己很清醒，决定自己开车回家。开出不远就被交警拦下了：你知道你在逆行吗？你一看：对啊，我在逆行！', icon: '🚗', type: 'risk', guaranteed: false, options: [{ text: '认罚', percentMin: -12, percentMax: -8, probability: 0.8, description: '扣分，罚款，拘留', moralValue: -5 }, { text: '辩解', percentMin: -15, percentMax: -8, probability: 0.2, description: '你说你只开了一小段，交警说：所以我们及时拦住了你，感谢我们吧', moralValue: -10 }] },
  { id: 'se5', title: '直播打赏冲动', description: '你看直播时，有个主播在哭：今天是我妈妈的忌日，我想妈妈了。你头脑一热刷了大礼物！第二天你冷静下来，发现那主播正在笑：今天是我妈妈的忌日，每年这天我都哭一场骗礼物~', icon: '🎁', type: 'risk', guaranteed: false, options: [{ text: '认了', percentMin: -18, percentMax: -10, probability: 0.6, description: '你删了账号，发誓再也不看直播了', moralValue: -10 }, { text: '发帖曝光', percentMin: -3, percentMax: 3, probability: 0.4, description: '你发帖曝光，结果被粉丝网暴了几天', moralValue: 10 }] },
  { id: 'se6', title: '加盟奶茶店', description: '看到某品牌奶茶店很火，明星代言的，你决定加盟。交了加盟费后发现：那条街已经有好多家同品牌店了！', icon: '🧋', type: 'risk', guaranteed: false, options: [{ text: '硬着头皮开', percentMin: -18, percentMax: -10, probability: 0.5, description: '你开业了，每天顾客不超过几个', moralValue: -5 }, { text: '转让', percentMin: -25, percentMax: -15, probability: 0.5, description: '你转让了店，接手的人说：你人真好，没告诉我这店有多坑', moralValue: 5 }] },
  { id: 'se7', title: '买期房烂尾', description: '你买了套房，结果成了烂尾楼。你去维权，发现开发商已经跑路了，更惨的是：你每月还要还房贷！', icon: '🏗️', type: 'risk', guaranteed: false, options: [{ text: '继续还贷', percentMin: -15, percentMax: -8, probability: 0.7, description: '你一边租房一边还贷，每月入不敷出', moralValue: -5 }, { text: '断供', percentMin: -18, percentMax: -10, probability: 0.3, description: '银行打电话威胁要拍卖你的其他财产', moralValue: -15 }] },
  { id: 'se8', title: '炒股被套', description: '牛市来了，你冲进了股市。买了支"专家推荐"的股票，结果专家推荐的第二天就跌停了！专家说：这是正常调整，你继续持有...然后股票跌了很多', icon: '📉', type: 'risk', guaranteed: false, options: [{ text: '割肉', percentMin: -18, percentMax: -10, probability: 0.6, description: '你含泪卖出，发誓再也不炒股了', moralValue: -5 }, { text: '持有', percentMin: -12, percentMax: 5, probability: 0.4, description: '你赌它会涨，结果它退市了', moralValue: -15 }] },
  { id: 'se9', title: '高价买演唱会票', description: '你追的偶像终于来开演唱会了！官网站几秒就售罄，你只好找黄牛买票，结果买到了假票', icon: '🎤', type: 'risk', guaranteed: false, options: [{ text: '自认倒霉', percentMin: -30, percentMax: -20, probability: 0.7, description: '你白跑一趟，钱也没了', moralValue: -10 }, { text: '找黄牛算账', percentMin: -25, percentMax: -15, probability: 0.3, description: '黄牛跑了，你报警也没用', moralValue: -5 }] },
  { id: 'se10', title: '买二手豪车', description: '你看到一辆超便宜的二手豪车，才几万块！买下来后发现：发动机要大修，变速箱有问题，还有几十条违章没处理', icon: '🚙', type: 'risk', guaranteed: false, options: [{ text: '修车', percentMin: -40, percentMax: -25, probability: 0.5, description: '修车费比你买车钱还贵', moralValue: -5 }, { text: '卖掉', percentMin: -35, percentMax: -20, probability: 0.5, description: '根本没人要，你亏了一大笔', moralValue: -10 }] },
  { id: 'se11', title: '被骗投资玉石', description: '朋友带你去"投资"玉石，说稳赚不赔。你买了一大堆，结果拿去鉴定：全是假的', icon: '💎', type: 'risk', guaranteed: false, options: [{ text: '报警', percentMin: -30, percentMax: -15, probability: 0.4, description: '警察说这种案子很难追查', moralValue: 5 }, { text: '找朋友', percentMin: -35, percentMax: -20, probability: 0.6, description: '朋友说：我也是被骗的，然后就消失了', moralValue: -15 }] },
  { id: 'se12', title: '冲动买奢侈品', description: '你心情不好，去商场逛街。销售一顿夸，你头脑一热买了个奢侈品包。回家冷静后发现：这包的质量还不如你妈织的编织袋', icon: '👜', type: 'risk', guaranteed: false, options: [{ text: '退掉', percentMin: -5, percentMax: 0, probability: 0.3, description: '销售说：拆封了不能退', moralValue: -5 }, { text: '认了', percentMin: -35, percentMax: -25, probability: 0.7, description: '你用了一个月就后悔了', moralValue: -10 }] },
  { id: 'se13', title: '被电信诈骗', description: '你接到电话说你涉嫌洗钱，需要把资金转到"安全账户"。你照做了，然后发现这是诈骗电话', icon: '📞', type: 'risk', guaranteed: false, options: [{ text: '报警', percentMin: -30, percentMax: -15, probability: 0.5, description: '警察说会尽力追查，但钱已经被转走了', moralValue: 5 }, { text: '自认倒霉', percentMin: -40, percentMax: -30, probability: 0.5, description: '你发誓再也不接陌生电话了', moralValue: -10 }] },
  { id: 'se14', title: '买养生保健品', description: '你参加了个"健康讲座"，讲师说这个保健品包治百病。你买了一堆，回家一查：就是普通食品', icon: '💊', type: 'risk', guaranteed: false, options: [{ text: '退货', percentMin: -10, percentMax: -5, probability: 0.3, description: '店已经关门了', moralValue: -5 }, { text: '自己吃', percentMin: -30, percentMax: -20, probability: 0.7, description: '你吃了半年也没见有什么效果', moralValue: -10 }] },
  { id: 'se15', title: '装修被坑', description: '你找了家装修公司，合同写着"一口价"。装修到一半，工头说：这里要加钱，那里也要加钱，不加钱就停工', icon: '🔨', type: 'risk', guaranteed: false, options: [{ text: '妥协', percentMin: -45, percentMax: -30, probability: 0.6, description: '你花了两倍的预算', moralValue: -10 }, { text: '换人', percentMin: -35, percentMax: -20, probability: 0.4, description: '你重新找人装修，但之前付的钱要不回来了', moralValue: -5 }] },
];
