...
const workIncomeEvents: GameEvent[] = [
  ...
  { id: 'w6', title: '代驾服务', description: '酒店门口有人需要代驾服务。你接了单，开到一半发现：这车居然没有刹车！你一路用手动刹车+撞墙，终于停下来了', icon: '🚗', type: 'work', guaranteed: false, options: [{ text: '撞墙停下', percentMin: -20, percentMax: -10, probability: 0.4, description: '你赔了修墙费，但车主说你很有创意，给你加了钱', moralValue: 5 }, { text: '拉手刹', percentMin: 10, percentMax: 25, probability: 0.6, description: '你用惯性漂移停车，车主惊呆了，多给了你一大笔', moralValue: 15 }] },
...
const dailyConsumptionEvents: GameEvent[] = [
  ...
  { id: 'c8', title: '打车回家', description: '下班太累了，不想挤地铁。你打了车，结果堵了很久才到家，车费比坐地铁贵很多', icon: '🚗', type: 'consumption', guaranteed: false, options: [{ text: '认了', percentMin: -20, percentMax: -10, probability: 0.8, description: '你看着计价器，心在滴血', moralValue: -5 }, { text: '投诉堵车', percentMin: -10, percentMax: 0, probability: 0.2, description: '司机说你行你上，你被赶下了车', moralValue: -10 }] },
...
const specialIncomeEvents: GameEvent[] = [
  ...
  { id: 'sp5', title: '投稿被采用', description: '你学生时代写的小说突然被影视公司看中了！他们说要改编，但预算有限，只能给你一顿饭', icon: '✍️', type: 'opportunity', guaranteed: false, options: [{ text: '同意', percentMin: 10, percentMax: 30, probability: 0.6, description: '你吃了饭，虽然署名权没了，但获得了"选角建议权"', moralValue: 5 }, { text: '拒绝', percentMin: 50, percentMax: 100, probability: 0.4, description: '你拒绝了，结果另一个公司以更高的价格买走了版权', moralValue: 15 }] },
];
